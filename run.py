...
from model.data import MySQuAD
from model.ema import EMA
import evaluate
from model.process import DataSet
...
def main():
    ...
    parser.add_argument('--dev-file', default='toy30data.train.json')
    ...
    parser.add_argument('--train-file', default='toy30data.train.json')
    # parser.add_argument('--word-dim', default=100, type=int)
    args = parser.parse_args()

    print('loading SQuAD data...')
    data = DataSet('.data/toy30data.train.json')
